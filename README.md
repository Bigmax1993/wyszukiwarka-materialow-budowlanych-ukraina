...
**Kampania produkcyjna:** UA materiały (GitHub Actions). DE GU — kod w `legacy/`, wyłączony z harmonogramu PC i CI.
...
```
├── legacy/de_gu/           # archiwum DE GU
├── ua_materialy_scraper.py
├── ua_oblast_rotation.py
├── libs/
├── schedule/ua/            # harmonogram PC UA
├── run_config/ua_materialy.json
├── docs/                   # GITHUB_ACTIONS.md, GOOGLE_DRIVE.md
├── scripts/                # gdrive_*, RUN_ALL_TESTS.ps1, run_full_pipeline_gha.ps1
├── tests/test_ua_*
